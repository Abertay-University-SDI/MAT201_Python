...
# 
# We'll create a visualisation of a ball collision with a wall. This will solve the maths equations we learned in the lecture, using a value of initial speed, angle of incidence and coefficient of restitution to calculate beta and post-collision speed. To show off a bit, we'll then animate it!
